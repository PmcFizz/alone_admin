<template>
    <Row>
        <Col span="24">
            <Button type="info" @click="createSimplePdf">创建PDF</Button>
            <Button type="success" @click="htmlToPdf">INPUT</Button>
            <Button type="warning" @click="textElement">textElement</Button>
            <Button type="error" @click="clickGraphic">Graphic element</Button>
        </Col>
    </Row>
</template>
